...
export default function HeroSection() {
  ...
  useEffect(() => {
    ...
    if (splineContainer && !splineContainer.hasChildNodes()) {
      ...
      viewer.setAttribute('url', 'https://prod.spline.design/h3Ws-VBARUkWGJqd/scene.splinecode');
      viewer.setAttribute('style', 'width: 100%; height: 100%; border-radius: 0.5rem;');
  ...
  return (
    <>
      <Script type="module" src="https://unpkg.com/@splinetool/viewer@1.10.51/build/spline-viewer.js" strategy="lazyOnload" />
      <section id="hero" className="relative min-h-screen w-full flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto grid lg:grid-cols-2 gap-8 items-center relative z-10 px-4">
          ...
          <div className="relative hidden lg:flex items-center justify-center h-[500px]">
            <div id="spline-container" className="w-full h-full"></div>
          </div>
        </div>
      </section>
    </>
